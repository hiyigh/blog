...
import blog.users.inApp.port.input.response.userInfo.GoogleUserInfo;
import blog.users.inApp.port.input.response.userInfo.NaverUserInfo;
import blog.users.inApp.port.input.response.userInfo.Oauth2UserInfo;
import blog.users.inApp.port.input.response.userInfo.ProviderType;
